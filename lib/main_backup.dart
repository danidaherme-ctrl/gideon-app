...
String tr(String arabic, String english) {
  return GideonSettings.instance.language == 'English'
      ? english
      : arabic;
}
            ...
            children: [
              ...
              _card([
                ...
                ListTile(
                  ...
                  title: Text('تغيير كلمة المرور'),
                  subtitle: Text('تحديث كلمة مرور حساب Gideon'),
                  trailing: Icon(Icons.chevron_left_rounded),
              ...
              _card([
                SwitchListTile.adaptive(
                  ...
                  title: Text('حفظ سجل المحادثات'),
                  subtitle: Text('التحكم بحفظ المحادثات السابقة'),
                ...
                ListTile(
                  ...
                  subtitle: Text('حذف وإدارة بيانات الحساب'),
                  trailing: Icon(Icons.chevron_left_rounded),
              ...
              _card([
                SwitchListTile.adaptive(
                  ...
                  subtitle: Text('السماح بإشعارات Gideon'),
              ...
              _card([
                ListTile(
                  ...
                  title: Text('Gideon Pro'),
                  subtitle: Text('\$4.99 / month • قريبًا'),
                  trailing: Icon(Icons.chevron_left_rounded),
                ...
                ListTile(
                  ...
                  title: Text('موقع Gideon'),
                  subtitle: Text('gideonassistant.uk'),
                  trailing: Icon(Icons.open_in_new_rounded, size: 19),
                  onTap: () => launchUrl(
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('الحساب والتخصيص والخصوصية'),
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(
                  MaterialPageRoute(
