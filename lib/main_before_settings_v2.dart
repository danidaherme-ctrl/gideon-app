    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF5FE7FF),
          brightness: Brightness.dark,
        ),
      ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(24),
          border: Border.all(
            color: const Color(0xFF5FE7FF).withValues(alpha: 0.20),
          ),
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF5FE7FF).withValues(alpha: 0.05),
              blurRadius: 24,
              spreadRadius: 1,
            ),
          ],
